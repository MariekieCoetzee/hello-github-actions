...
SVC_NAME="actions.runner.MariekieCoetzee-hello-github-actions.Mariekies-MacBook-Air"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (MariekieCoetzee-hello-github-actions.Mariekies-MacBook-Air)"
